...
# Cloud Scheduler 설정 스크립트 (하루 2회: 00시, 12시)
...
# 3. 새 스케줄러 작업 생성 (하루 2회: 00시, 12시)
echo "Step 3: 스케줄러 작업 생성 (하루 2회: 00시, 12시)"
gcloud scheduler jobs create http $SCHEDULER_JOB_NAME \
  ...
  --description="정부 정책 자동 블로그 포스팅 (00시, 12시 하루 2회)"
